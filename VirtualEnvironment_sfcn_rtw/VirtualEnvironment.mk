...
MAKEFILE           = VirtualEnvironment.mk
MATLAB_ROOT        = /usr/local/matlab2011b
ALT_MATLAB_ROOT    = /usr/local/matlab2011b
MASTER_ANCHOR_DIR  = 
START_DIR          = /home/ruud/svn/trunk/src/E-box/Yanick
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
COMPUTER           = GLNXA64
MEXEXT             = mexa64
BUILDARGS          =  GENERATE_REPORT=0 MODELLIB=VirtualEnvironmentlib.a RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
USERMODULES        =  
CREATEMODEL        = 1
USEPARAMVALUES     = 0
PURIFY             = 0
...
ADD_INCLUDES = \
	-I$(START_DIR)/VirtualEnvironment_sfcn_rtw \
	-I$(START_DIR) \
