...
#
# File    : singledof_base.mk   $Revision: 1.81.4.22.2.1 $
#
# Abstract:
...
MODEL                = singledof_base
MODULES              = rtGetInf.c rtGetNaN.c rt_logging.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_sfcn_helper.c singledof_base_data.c 
MAKEFILE             = singledof_base.mk
MATLAB_ROOT          = /usr/local/matlab2011b
ALT_MATLAB_ROOT      = /usr/local/matlab2011b
S_FUNCTIONS          = ec_EL5101_enc.c VirtualEnvironment_sf.c ec_EL1008_di.c ec_EL3102_adc.c ec_EL5101_latch.c ec_EL4038_dac.c ec_EL2008_do.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
ADD_INCLUDES = \
	-I/home/ruud/svn/trunk/src/E-box/HC2018_Christopher_Linda/Measurements_part2/HC2018_CopyFirst_DONOTMODIFY/singledof_base_et_rtw \
